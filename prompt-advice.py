...
def main():
    ...
    user_prompt = (
        "You are an AI prompt adviser. I have the following prompt that I need to be improved:\n\n"
        "I will use the $$$ symbol uniquely for you to not confuse to user markers in the text.\n\n"
        f"$$$\n{original_content}\n$$$\n\n"
        "Please return the entire updated prompt with the changes applied, without omitting any part of the text.\n"
        "I want to apply the following changes:\n"
        "The prompt should have the text in the right order and in a away that is not confusing for a model like GPT4-o3 that will be reading it.\n"
